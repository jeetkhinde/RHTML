...
fn page(props: PageProps) {
  <div class="container">
    ...
    <div class="demo-section">
      ...
      <div class="features-grid">
        <div class="feature-card">
          ...
          <h3>Static Routes</h3>
          <p><code>pages/about.rhtml</code> → <code>/about</code></p>
        </div>

        <div class="feature-card">
          <div class="feature-icon">🔀</div>
          <h3>Dynamic Routes</h3>
          <p><code>pages/users/[id].rhtml</code> → <code>/users/:id</code></p>
        </div>

        <div class="feature-card">
          <div class="feature-icon">📄</div>
          <h3>Index Pages</h3>
          <p><code>pages/users/index.rhtml</code> → <code>/users</code></p>
        </div>
      ...
      <div class="examples">
        <div class="example">
          ...
          <ul class="example-links">
            <li><a href="/">/</a> <span>→ pages/index.rhtml</span></li>
            <li><a href="/about">/about</a> <span>→ pages/about.rhtml</span></li>
            <li><a href="/components">/components</a> <span>→ pages/components.rhtml</span></li>
          </ul>
        </div>
        ...
        <div class="example">
          ...
          <ul class="example-links">
            <li><a href="/users/1">/users/1</a> <span>→ pages/users/[id].rhtml (id=1)</span></li>
            <li><a href="/users/42">/users/42</a> <span>→ pages/users/[id].rhtml (id=42)</span></li>
            <li><a href="/users/admin">/users/admin</a> <span>→ pages/users/[id].rhtml (id=admin)</span></li>
          </ul>
        </div>
        ...
        <div class="example">
          ...
          <ul class="example-links">
            <li><a href="/users/new">/users/new</a> <span>→ pages/users/new.rhtml (NOT [id].rhtml!)</span></li>
          </ul>
        ...
        <div class="example">
          ...
          <ul class="example-links">
            <li><a href="/users">/users</a> <span>→ Uses pages/users/_layout.rhtml</span></li>
            <li><a href="/users/1">/users/1</a> <span>→ Uses pages/users/_layout.rhtml</span></li>
            <li><a href="/">/</a> <span>→ Uses pages/_layout.rhtml (root layout)</span></li>
          </ul>
        </div>
      </div>
    </div>
    ...
    <div class="info-box">
      <h3 class="info-title">💡 How to Create Dynamic Routes</h3>
      <ol class="info-list">
